# Usage:
# docker run -d --name=sysPass -p 80:80 -p 443:443 nuxsmin/docker-syspass:3.0
...
LABEL maintainer=nuxsmin@syspass.org version=3.0.5 php=7.0 environment=production
